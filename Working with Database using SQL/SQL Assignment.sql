...
-- 3.Create the ContactEmployee Table
...
-- 4.Insert Data into Company Table
...
-- 6.Remove Dianne Connor’s Contact with Jack Lee

delete from ContactEmployee
where ContactEmployeeID = 2;

-- 7.Retrieve Employees Who Contacted Toll Brothers
